...
const licensedModernText = { type: "licensed-required", note: "现代课文默认不内置全文，请使用课本阅读原文；这里提供导读、字词、阅读题和写作迁移。" };
const publicDomainText = { type: "public-domain", note: "古代公版文本，可展开诵读和默写。" };

function chineseLesson(unitIndex, lessonIndex, number, title, meta) {
  const keyPoints = [...meta.keyPoints, buildChineseExpressionPoint(meta.unitTitle)];
  const readingFocus = meta.readingFocus ?? keyPoints.slice(0, 3);
  const readingQuestions = meta.readingQuestions ?? buildChineseReadingQuestions(`${number} ${title}`, readingFocus);

  return {
    id: `chi-${unitIndex}-${lessonIndex}`,
    title: `${number} ${title}`,
    author: meta.author,
    source: meta.source,
    genre: meta.genre,
    ...
    keyPoints,
    readingFocus,
    previewGuide: meta.previewGuide ?? buildChinesePreviewGuide(`${number} ${title}`, meta, keyPoints, readingFocus),
    readingQuestions,
    readingExplanations: meta.readingExplanations ?? buildChineseReadingExplanations(`${number} ${title}`, meta, readingQuestions, readingFocus),
    writingTask: meta.writingTask ?? buildChineseWritingTask(meta.unitTitle, `${number} ${title}`),
    tasks: ["读导读", "默写字词", "回答阅读题", "完成写作迁移"],
  };
}

const yueyangloujiText = `庆历四年春，滕子京谪守巴陵郡。越明年，政通人和，百废具兴。乃重修岳阳楼，增其旧制，刻唐贤今人诗赋于其上。属予作文以记之。
...
const zuiwengtingjiText = `环滁皆山也。其西南诸峰，林壑尤美，望之蔚然而深秀者，琅琊也。山行六七里，渐闻水声潺潺，而泻出于两峰之间者，酿泉也。峰回路转，有亭翼然临于泉上者，醉翁亭也。
...
const huxintingText = `崇祯五年十二月，余住西湖。大雪三日，湖中人鸟声俱绝。
...
予观夫巴陵胜状 / 在洞庭一湖。衔远山 / 吞长江 / 浩浩汤汤 / 横无际涯。朝晖夕阴 / 气象万千。`,
  ...
  practice: [
    {
      type: "翻译",
      question: "翻译：不以物喜，不以己悲。",
      answer: "不因外物好坏和个人得失而或喜或悲。",
      explanation: "以，因；物，外物；己，自己。翻译时要补出“因”的意思。",
    },
    {
      type: "阅读",
      question: "“先天下之忧而忧，后天下之乐而乐”为什么能体现古仁人之心？",
      answer: "这句话把个人得失放在天下百姓之后，表现以天下为己任的政治抱负。",
      explanation: "答题时先解释句意，再点出胸怀和责任，不只写“很伟大”。",
    },
  ],
};
...
峰回路转 / 有亭翼然临于泉上者 / 醉翁亭也。醉翁之意不在酒 / 在乎山水之间也。`,
  ...
  practice: [
    {
      type: "翻译",
      question: "翻译：醉翁之意不在酒，在乎山水之间也。",
      answer: "醉翁的情趣不在酒上，而在山水之间。",
      explanation: "意，情趣；乎，相当于“于”。不要把“意”只译成“意思”。",
    },
    {
      type: "阅读",
      question: "文章中的“乐”有哪些层次？",
      answer: "有山水之乐、宴饮之乐、游人之乐，最后落到太守与民同乐。",
      explanation: "先分层概括，再指出结尾把个人游赏提升到与民同乐的主题。",
    },
  ],
};
...
雾凇沆砀 / 天与云与山与水 / 上下一白。湖上影子 / 惟长堤一痕 / 湖心亭一点 / 与余舟一芥 / 舟中人两三粒而已。`,
  ...
  practice: [
    {
      type: "翻译",
      question: "翻译：大雪三日，湖中人鸟声俱绝。",
      answer: "大雪下了三天，湖中行人和鸟的声音都消失了。",
      explanation: "俱，全部；绝，消失、断绝。这里写出雪后西湖的静。",
    },
    {
      type: "阅读",
      question: "“一痕、一点、一芥、两三粒”有什么表达效果？",
      answer: "用极小的数量词写极大的雪景空间，突出天地苍茫和人物渺小。",
      explanation: "答题时要说清“以小写大”的效果，并联系白描手法。",
    },
  ],
};

const poetryThreeClassicalSupport = {
  segmentedText: `金樽清酒 / 斗十千，玉盘珍羞 / 直万钱。停杯投箸 / 不能食，拔剑四顾 / 心茫然。

巴山楚水 / 凄凉地，二十三年 / 弃置身。沉舟侧畔 / 千帆过，病树前头 / 万木春。

明月 / 几时有？把酒 / 问青天。不应有恨，何事 / 长向别时圆？但愿人长久，千里 / 共婵娟。`,
  lineTranslations: [
    {
      text: "停杯投箸不能食，拔剑四顾心茫然。",
      translation: "放下酒杯、丢下筷子吃不下，拔出宝剑环顾四周，心里一片茫然。",
    },
    {
      text: "沉舟侧畔千帆过，病树前头万木春。",
      translation: "沉船旁边有千帆竞发，病树前头有万木逢春。",
    },
    {
      text: "但愿人长久，千里共婵娟。",
      translation: "只愿亲人平安长久，即使相隔千里，也能共赏这美好的月光。",
    },
  ],
  wordNotes: [
    { word: "金樽", meaning: "精美的酒杯" },
    { word: "珍羞", meaning: "珍贵的菜肴，羞同“馐”" },
    { word: "直", meaning: "同“值”，价值" },
    { word: "投箸", meaning: "放下筷子" },
    { word: "弃置身", meaning: "指长期被贬、遭弃置的处境" },
    { word: "长精神", meaning: "振作精神" },
    { word: "宫阙", meaning: "宫殿" },
    { word: "婵娟", meaning: "月亮，也指美好的月光" },
  ],
  specialSentences: [
    { label: "典故", text: "闲来垂钓碧溪上、忽复乘舟梦日边：借典故表达仍期待被重用。" },
    { label: "哲理句", text: "沉舟侧畔千帆过，病树前头万木春：新事物终将代替旧事物。" },
    { label: "情感转折", text: "但愿人长久，千里共婵娟：由离别惆怅转向旷达祝愿。" },
  ],
  practice: [
    {
      type: "翻译",
      question: "翻译：沉舟侧畔千帆过，病树前头万木春。",
      answer: "沉船旁边有千帆竞发，病树前头有万木逢春。",
      explanation: "翻译后还要能说出哲理：困境之外仍有新生和希望。",
    },
    {
      type: "阅读",
      question: "三首诗词共同体现了怎样的情感变化？",
      answer: "都从困顿、贬谪或离别出发，最后转向自信、昂扬或旷达。",
      explanation: "答题时要分别对应李白、刘禹锡、苏轼，不要只概括成“积极乐观”。",
    },
  ],
};
...
curriculum.chinese.chapters = [
  {
    title: "第一单元 诗歌活动探究",
    overview: "诗歌单元按朗读节奏、意象组合、情感变化和仿写迁移预习。",
    lessons: [
      chineseLesson(1, 1, "1", "沁园春·雪", {
        unitTitle: "第一单元 诗歌活动探究",
        author: "毛泽东",
        genre: "词",
        intro: "先分清上下片：上片铺展北国雪景，写景中见气魄；下片评价历史人物，最后把豪迈情感落到当代。预习时重点看意象怎样从空间、色彩和动作中展开。",
        dictationWords: ["妖娆", "风骚", "折腰", "天骄", "风流", "莽莽", "滔滔", "俱往矣", "红装素裹", "一代天骄"],
        keyPoints: ["上下片结构", "雪景意象", "历史人物评价", "豪迈情感"],
        readingFocus: ["上片写景的空间顺序", "下片议论的转折", "末句情感落点"],
        readingQuestions: ["上片哪些词语体现了雪景的宏阔气势？", "作者评价历史人物的目的是什么？", "结尾怎样把写景、议论和抒情合在一起？"],
        writingTask: "仿照“景物铺陈 -> 观点转折 -> 情感落点”的结构，写 100 字校园雪景或雨景片段。",
      }),
      chineseLesson(1, 2, "2", "周总理，你在哪里", {
        unitTitle: "第一单元 诗歌活动探究",
        author: "柯岩",
        genre: "现代诗",
        intro: "这首诗用反复呼告形成寻找的节奏，把山谷、大地、森林和海防等场景串联起来。预习时不要只读出悲伤，还要抓住人民怀念周总理的广阔视角。",
        dictationWords: ["谷穗", "篝火", "海防", "沉甸甸", "轰鸣", "宿营", "辽阔", "心脏", "足迹", "呼唤"],
        keyPoints: ["呼告式抒情", "反复手法", "场景转换", "人民情感"],
        readingFocus: ["反复句式的情感推动", "不同地点的象征意味", "寻找与怀念的关系"],
        readingQuestions: ["诗中多次呼唤“你在哪里”有什么作用？", "几个场景为什么能代表人民生活？", "结尾的情感和前面的寻找有什么联系？"],
        writingTask: "选一个值得纪念的人，用“我在……寻找你”的句式写 80 字片段。",
      }),
      chineseLesson(1, 3, "3", "我爱这土地", {
        unitTitle: "第一单元 诗歌活动探究",
        author: "艾青",
        genre: "现代诗",
        intro: "诗人把自己想象成一只鸟，用土地、河流、风、黎明等意象表达深沉的家国之爱。预习时要把“嘶哑”“腐烂”等词和时代背景联系起来读。",
        dictationWords: ["嘶哑", "汹涌", "腐烂", "黎明", "激怒", "悲愤", "温柔", "深沉", "土地", "羽毛"],
        keyPoints: ["象征意象", "鸟的抒情视角", "爱国情感", "时代背景"],
        readingFocus: ["鸟这一形象的象征作用", "土地意象的情感重量", "结尾直抒胸臆的力量"],
        readingQuestions: ["诗人为什么选择“鸟”来抒情？", "“土地”在诗中不仅指什么？", "最后两句为什么能成为全诗情感核心？"],
        writingTask: "用一个具体意象表达对家乡或校园的感情，写 80-100 字。",
      }),
      chineseLesson(1, 4, "4", "乡愁", {
        unitTitle: "第一单元 诗歌活动探究",
        author: "余光中",
        genre: "现代诗",
        intro: "这首诗用邮票、船票、坟墓、海峡四个意象推进时间和空间，情感由个人亲情扩展到家国之思。预习时重点看每节意象为什么越来越沉重。",
        dictationWords: ["邮票", "船票", "坟墓", "海峡", "乡愁", "新娘", "母亲", "后来", "浅浅", "大陆"],
        keyPoints: ["时间顺序", "意象递进", "家国情怀", "结构反复"],
        readingFocus: ["四个意象的递进关系", "小我到大我的情感扩展", "重章复沓的音乐感"],
        readingQuestions: ["四个意象分别对应怎样的离别？", "为什么最后一个意象是“海峡”？", "全诗反复句式带来了怎样的表达效果？"],
        writingTask: "仿照“小时候/长大后/后来/现在”的结构，写一组 4 句主题小诗。",
      }),
      chineseLesson(1, 5, "5", "你是人间的四月天", {
        unitTitle: "第一单元 诗歌活动探究",
        author: "林徽因",
        genre: "现代诗",
        intro: "诗歌以四月天为核心意象，把轻灵、明净、鲜妍的感受层层展开。预习时抓颜色、声音、光影和比喻，体会诗人如何把抽象情感写得可感。",
        dictationWords: ["轻灵", "娉婷", "鲜妍", "冠冕", "呢喃", "梁间", "鹅黄", "柔嫩", "庄严", "梦中"],
        keyPoints: ["比喻群", "色彩描写", "节奏轻快", "情感赞美"],
        readingFocus: ["四月天意象的统领作用", "色彩词和声音词的配合", "赞美对象的多重含义"],
        readingQuestions: ["诗中哪些词最能体现“四月天”的轻灵？", "比喻和色彩描写怎样表达赞美？", "全诗的节奏为什么显得明亮而轻快？"],
        writingTask: "选择“秋天的一阵风”或“清晨的一束光”，用 3 个比喻写 80 字。",
      }),
      chineseLesson(1, 6, "6", "我看", {
        unitTitle: "第一单元 诗歌活动探究",
        author: "穆旦",
        genre: "现代诗",
        intro: "诗中“我看”不断展开视野，把自然景象、生命感受和青春精神连在一起。预习时先读出画面，再看诗句如何从景物转向内心，并留意语气由舒展到昂扬的变化。",
        dictationWords: ["丰润", "忧戚", "勃发", "漫游", "飘逸", "摇曳", "凝望", "辽远", "翅翼", "沉醉"],
        keyPoints: ["自然意象", "视角推进", "青春感受", "语言节奏"],
        readingFocus: ["“我看”句式的视角变化", "自然景象与生命感受的连接", "诗歌节奏和情绪的起伏"],
        readingQuestions: ["诗中哪些景象最能表现生命的勃发？", "“我看”的反复有什么结构作用？", "诗人的情绪是怎样由外景转入内心的？"],
        writingTask: "用“我看……”开头连续写 4 句，表现一个季节给你的感受。",
      }),
    ],
  },
  {
    title: "第二单元 议论性文章",
    overview: "议论文单元按论点、论据、论证方法和语言态度预习。",
    lessons: [
      chineseLesson(2, 1, "7", "敬业与乐业", {
        unitTitle: "第二单元 议论性文章",
        author: "梁启超",
        genre: "议论文",
        intro: "文章围绕“敬业”和“乐业”展开，把职业态度讲成做人做事的根本。预习时先找中心论点，再看作者怎样引用名言、举例说明和层层推进。",
        dictationWords: ["旁骛", "亵渎", "强聒不舍", "佝偻", "承蜩", "骈进", "秘诀", "妄想", "敬业乐群", "断章取义"],
        keyPoints: ["中心论点", "引用论证", "举例论证", "演讲语言"],
        readingFocus: ["敬业与乐业的关系", "引用材料的证明作用", "口语化表达的感染力"],
        readingQuestions: ["作者怎样解释“敬业”的必要性？", "文中引用孔子等材料有什么作用？", "为什么说“乐业”不是逃避辛苦？"],
        writingTask: "围绕“做一件小事也要认真”写一段观点 + 事例 + 小结的议论片段。",
      }),
      chineseLesson(2, 2, "8", "就英法联军远征中国致巴特勒上尉的信", {
        unitTitle: "第二单元 议论性文章",
        author: "雨果",
        genre: "书信/议论",
        intro: "这封信以强烈反讽批判侵略者，把圆明园的辉煌和劫掠者的野蛮形成对照。预习时重点辨析赞美词背后的讽刺态度，并标出作者立场最鲜明的句子。",
        dictationWords: ["赞誉", "恍若", "绸缎", "瞥见", "箱箧", "制裁", "赃物", "惊骇", "荡然无存", "富丽堂皇"],
        keyPoints: ["反讽语气", "对比手法", "文明批判", "书信对象"],
        readingFocus: ["圆明园描写的铺垫作用", "反语表达的批判力度", "作者立场和人道精神"],
        readingQuestions: ["作者为什么先极力赞美圆明园？", "文中的“胜利者”一类词为什么带有讽刺意味？", "这封信体现了作者怎样的文明观？"],
        writingTask: "用反讽手法写 80 字评论，批评一种不文明行为。",
      }),
      chineseLesson(2, 3, "9", "论教养", {
        unitTitle: "第二单元 议论性文章",
        author: "利哈乔夫",
        genre: "议论文",
        intro: "文章把教养落实到日常行为，强调真正的教养不是外表礼节，而是尊重他人、克制自己。预习时把正面表现和反面表现分组整理，再用身边例子判断观点是否成立。",
        dictationWords: ["贸然", "涵养", "恪守", "自持", "箴言", "允诺", "汲取", "疲惫", "彬彬有礼", "矫揉造作"],
        keyPoints: ["概念辨析", "生活事例", "正反对比", "论证层次"],
        readingFocus: ["教养的真正内涵", "生活细节作为论据", "作者语气的平和与坚定"],
        readingQuestions: ["作者为什么反复从生活小事谈教养？", "真正的教养和表面礼貌有什么区别？", "文中正反对比怎样增强说服力？"],
        writingTask: "选一个校园细节，写一段“现象 + 判断 + 改进建议”的短评。",
      }),
      chineseLesson(2, 4, "10", "精神的三间小屋", {
        unitTitle: "第二单元 议论性文章",
        author: "毕淑敏",
        genre: "散文式议论",
        intro: "文章用“三间小屋”比喻人的精神空间，分别安放爱恨、事业和自我。预习时要抓住比喻背后的逻辑：精神世界也需要整理和守护，并思考三间小屋之间的关系。",
        dictationWords: ["广袤", "宽宥", "游弋", "轻觑", "濡养", "灰烬", "积攒", "坍塌", "鸠占鹊巢", "自惭形秽"],
        keyPoints: ["比喻论证", "结构层次", "精神空间", "人生选择"],
        readingFocus: ["三间小屋分别象征什么", "比喻如何承载议论", "文章语言的抒情色彩"],
        readingQuestions: ["三间小屋各自对应怎样的精神内容？", "作者为什么说精神空间需要整理？", "文章的比喻让议论产生了什么效果？"],
        writingTask: "仿照“三间小屋”的比喻，写 100 字介绍自己的“精神书架”。",
      }),
    ],
  },
  {
    title: "第三单元 古诗文",
    overview: "古诗文单元按文言字词、翻译、背诵默写和主旨赏析预习，可展开公版原文。",
    lessons: [
      chineseLesson(3, 1, "11", "岳阳楼记", {
        unitTitle: "第三单元 古诗文",
        author: "范仲淹",
        source: "《范文正公集》",
        genre: "古文",
        ...
        readingFocus: ["两组景物描写的对照", "迁客骚人与古仁人的区别", "主旨句的背诵和理解"],
        readingQuestions: ["阴雨图和晴明图分别引出怎样的情感？", "“不以物喜，不以己悲”为什么是理解全文的关键？", "“先天下之忧而忧，后天下之乐而乐”体现了怎样的胸怀？"],
        writingTask: "选一句名句，写 100 字现代解释，并联系一次集体责任的经历。",
      }),
      chineseLesson(3, 2, "12", "醉翁亭记", {
        unitTitle: "第三单元 古诗文",
        author: "欧阳修",
        source: "《欧阳文忠公文集》",
        genre: "古文",
        ...
        readingFocus: ["亭名由来的叙述", "朝暮四时景物变化", "太守之乐的政治意味"],
        readingQuestions: ["文章写了哪几种“乐”？", "“醉翁之意不在酒”在文中怎样展开？", "结尾为什么点出“太守谓谁”？"],
        writingTask: "写一段 100 字游记，至少包含一处景物、一处人物活动和一句情感点明。",
      }),
      chineseLesson(3, 3, "13", "湖心亭看雪", {
        unitTitle: "第三单元 古诗文",
        author: "张岱",
        source: "《陶庵梦忆》",
        genre: "小品文",
        ...
        readingFocus: ["雪景白描的简洁", "“痴”字的人物评价", "遇客情节的作用"],
        readingQuestions: ["“上下一白”写出了怎样的境界？", "作者为什么选择更定后独往看雪？", "舟子说“痴”包含哪些意味？"],
        writingTask: "用白描写一个安静场景，控制在 80 字以内，少用形容词。",
      }),
      chineseLesson(3, 4, "14", "诗词三首", {
        unitTitle: "第三单元 古诗文",
        author: "李白、刘禹锡、苏轼",
        source: "唐诗宋词",
        genre: "古诗词",
        textSource: publicDomainText,
        originalText: poetryThreeText,
        classicalSupport: poetryThreeClassicalSupport,
        intro: "三首诗词都写人生处境中的情感转折：李白由艰难到自信，刘禹锡由沉郁到昂扬，苏轼由离别到旷达。预习时要背名句并说出转折处，同时能解释典故或意象的作用。",
        dictationWords: ["金樽", "歧路", "婵娟", "宫阙", "箸", "济沧海", "侧畔", "长精神", "琼楼玉宇", "阴晴圆缺"],
        keyPoints: ["典故运用", "情感转折", "名句默写", "人生旷达"],
        readingFocus: ["三首诗词的情绪变化", "典故和比喻的作用", "名句背诵与赏析"],
        readingQuestions: ["《行路难》中哪些句子表现了理想受阻？", "“沉舟侧畔千帆过”为什么能表达昂扬精神？", "《水调歌头》怎样把离别写成旷达？"],
        writingTask: "从三首中任选一句名句，写 100 字赏析，必须包含画面、情感和现实启发。",
      }),
    ],
  },
  {
    title: "第四单元 小说阅读",
    overview: "小说单元按情节、人物、环境和主题预习，不展示现代作品全文。",
    lessons: [
      chineseLesson(4, 1, "15", "故乡", {
        unitTitle: "第四单元 小说阅读",
        author: "鲁迅",
        genre: "小说",
        intro: "小说以回乡见闻写人物和时代变化，闰土、杨二嫂和“我”的感受构成理解主题的关键。预习时要比较过去与现在，重点看环境描写和人物语言。",
        dictationWords: ["阴晦", "萧索", "愕然", "鄙夷", "隔膜", "惘然", "恣睢", "寒噤", "五行缺土", "伶俐"],
        keyPoints: ["人物变化", "环境描写", "对比结构", "希望主题"],
        readingFocus: ["闰土前后变化的原因", "景物色调和心境关系", "结尾“路”的象征意义"],
        readingQuestions: ["少年闰土和中年闰土的差异体现在哪里？", "开头故乡景象为什么显得萧索？", "结尾关于“路”的议论表达了怎样的希望？"],
        writingTask: "写一个人物前后变化片段，用外貌、动作和一句语言表现差异。",
      }),
      chineseLesson(4, 2, "16", "我的叔叔于勒", {
        unitTitle: "第四单元 小说阅读",
        author: "莫泊桑",
        genre: "小说",
        intro: "小说通过菲利普夫妇对于勒态度的变化，讽刺金钱关系扭曲亲情。预习时把“盼于勒”和“躲于勒”的情节转折整理出来，再抓人物语言里的势利心理。",
        dictationWords: ["拮据", "栈桥", "糟蹋", "褴褛", "阔绰", "煞白", "诧异", "牡蛎", "郑重其事", "与日俱增"],
        keyPoints: ["情节转折", "人物语言", "讽刺手法", "金钱主题"],
        readingFocus: ["菲利普夫妇态度变化", "若瑟夫视角的作用", "结尾避开的讽刺意味"],
        readingQuestions: ["家人对于勒的期待为什么会发生突变？", "小说用哪些细节表现菲利普夫妇的虚伪？", "若瑟夫的叙述让主题多了什么意味？"],
        writingTask: "写一个 100 字片段，用一个小动作表现人物的尴尬或虚伪。",
      }),
      chineseLesson(4, 3, "17", "孤独之旅", {
        unitTitle: "第四单元 小说阅读",
        author: "曹文轩",
        genre: "小说",
        intro: "课文写杜小康在放鸭生活中的孤独、恐惧和成长。预习时不要只概括情节，要抓芦苇荡、暴风雨等环境怎样推动人物心理变化，并找出成长的具体证据。",
        dictationWords: ["嬉闹", "撩逗", "胆怯", "掺杂", "驱除", "镰刀", "仓皇", "厚实", "歇斯底里", "一落千丈"],
        keyPoints: ["成长主题", "环境烘托", "心理描写", "情节推进"],
        readingFocus: ["孤独感的层层加深", "暴风雨情节的转折作用", "杜小康成长的标志"],
        readingQuestions: ["杜小康的孤独主要来自哪些方面？", "暴风雨一段为什么是成长关键？", "环境描写怎样烘托人物心理？"],
        writingTask: "写一次独自面对困难的经历，突出一个环境细节和一个心理转折。",
      }),
    ],
  },
  {
    title: "第五单元 观点与思辨",
    overview: "思辨单元按观点、反驳、论据和语言锋芒预习。",
    lessons: [
      chineseLesson(5, 1, "18", "中国人失掉自信力了吗", {
        unitTitle: "第五单元 观点与思辨",
        author: "鲁迅",
        genre: "驳论文",
        intro: "文章先摆出错误论调，再用“他信力”“自欺力”和“中国的脊梁”层层反驳。预习时要分清敌论、反驳过程和正面立论，特别注意概念替换带来的讽刺力量。",
        dictationWords: ["玄虚", "诓骗", "怀古伤今", "脊梁", "渺茫", "慨叹", "诬蔑", "脂粉", "前仆后继", "自欺欺人"],
        keyPoints: ["驳论文结构", "论证思路", "语言锋芒", "民族精神"],
        readingFocus: ["敌论和作者观点的区分", "反驳中概念替换的力量", "“中国的脊梁”的含义"],
        readingQuestions: ["文章反驳的错误观点是什么？", "“他信力”“自欺力”两个说法有何讽刺效果？", "作者为什么要强调“中国的脊梁”？"],
        writingTask: "针对一种片面说法，写 120 字反驳段：先指出漏洞，再举例说明。",
      }),
      chineseLesson(5, 2, "19", "怀疑与学问", {
        unitTitle: "第五单元 观点与思辨",
        author: "顾颉刚",
        genre: "议论文",
        intro: "文章说明怀疑精神对于辨伪、求真的意义。预习时先找中心论点，再看作者怎样从消极方面和积极方面论证怀疑的价值，并整理引用材料的作用。",
        dictationWords: ["虚妄", "墨守", "辨伪去妄", "停滞", "盲从", "步骤", "流俗", "譬如", "不攻自破", "尽信书不如无书"],
        keyPoints: ["中心论点", "分论点", "引用论证", "思辨精神"],
        readingFocus: ["怀疑与学问的关系", "两个分论点的层次", "引用名言的证明作用"],
        readingQuestions: ["作者为什么说做学问离不开怀疑？", "怀疑的消极作用和积极作用分别是什么？", "引用孟子等材料有什么论证效果？"],
        writingTask: "写一段 100 字说明：面对网络消息，怎样用怀疑精神判断真假。",
      }),
      chineseLesson(5, 3, "20", "谈创造性思维", {
        unitTitle: "第五单元 观点与思辨",
        author: "罗迦·费·因格",
        genre: "议论文",
        intro: "文章围绕创造性思维的来源和训练展开，强调知识积累、灵活组合和持久探索。预习时把问题、例子和结论对应起来，再归纳作者给出的训练方法。",
        dictationWords: ["探求", "汲取", "根深蒂固", "锲而不舍", "模式", "素材", "创意", "灵感", "孜孜不倦", "不言而喻"],
        keyPoints: ["设问引入", "事例论证", "思维方法", "知识积累"],
        readingFocus: ["创造性思维不是天生神秘能力", "多个事例证明不同角度思考", "知识和灵感的关系"],
        readingQuestions: ["作者怎样破除“只有天才才有创造力”的误解？", "文中事例共同证明了什么？", "为什么创造性思维离不开知识积累？"],
        writingTask: "选一个生活小问题，列出三种不同解决办法，并说明哪一种最有创意。",
      }),
      chineseLesson(5, 4, "21", "创造宣言", {
        unitTitle: "第五单元 观点与思辨",
        author: "陶行知",
        genre: "宣言式议论",
        intro: "文章用有力的排比和反驳，宣告人人都有创造力。预习时抓住作者反驳的几种借口，再体会宣言式语言的号召力，并找出最有鼓动性的句式。",
        dictationWords: ["中伤", "遁词", "鲁钝", "懦夫", "豢养", "灌溉", "崇拜", "塑像", "走投无路", "山穷水尽"],
        keyPoints: ["排比句式", "反驳借口", "鼓动语言", "创造精神"],
        readingFocus: ["作者反驳的常见借口", "排比和短句的气势", "创造与教育的关系"],
        readingQuestions: ["文章反驳了哪些“不可能创造”的理由？", "排比句为什么能增强宣言感？", "作者所说的创造和日常学习有什么关系？"],
        writingTask: "仿照宣言式语气写 80 字，鼓励同学勇于尝试一件难事。",
      }),
    ],
  },
  {
    title: "第六单元 古典小说",
    overview: "古典小说单元按情节线索、人物群像、语言和讽刺艺术预习。",
    lessons: [
      chineseLesson(6, 1, "22", "智取生辰纲", {
        unitTitle: "第六单元 古典小说",
        author: "施耐庵",
        source: "《水浒传》",
        genre: "古典小说",
        intro: "节选围绕“押送”和“智取”两条线展开，杨志一方的谨慎与吴用一方的设计形成对照。预习时重点梳理明线暗线和人物语言，弄清失败与计谋如何互相推动。",
        dictationWords: ["嗔怪", "干系", "怨怅", "逞辩", "面面厮觑", "喏喏连声", "聒噪", "尴尬", "剜口割舌", "死心塌地"],
        keyPoints: ["明暗线索", "人物群像", "情节铺垫", "古白话语言"],
        readingFocus: ["明线和暗线如何交汇", "杨志性格的矛盾", "“智取”的层层铺垫"],
        readingQuestions: ["故事中明线和暗线分别是什么？", "杨志失败是否只因为不谨慎？", "吴用等人的计策“智”在哪里？"],
        writingTask: "用流程图概括一场“计策成功”的过程，再写 80 字说明关键转折。",
      }),
      chineseLesson(6, 2, "23", "范进中举", {
        unitTitle: "第六单元 古典小说",
        author: "吴敬梓",
        source: "《儒林外史》",
        genre: "讽刺小说",
        intro: "小说用范进中举前后的疯癫与众人态度变化，讽刺科举制度和世态人情。预习时抓夸张细节、对比人物和讽刺语言，理解可笑背后的可悲。",
        dictationWords: ["作揖", "带挈", "盘缠", "商酌", "桑梓", "侥幸", "轩敞", "尖嘴猴腮", "不省人事", "唯唯连声"],
        keyPoints: ["讽刺手法", "细节描写", "人物对比", "社会批判"],
        readingFocus: ["范进发疯的夸张效果", "胡屠户态度前后变化", "众人反应揭示的世态"],
        readingQuestions: ["范进中举后发疯为什么既可笑又可悲？", "胡屠户的语言变化说明什么？", "小说怎样通过众人反应完成讽刺？"],
        writingTask: "写一个 100 字讽刺片段，通过人物前后态度变化表现势利。",
      }),
      chineseLesson(6, 3, "24", "三顾茅庐", {
        unitTitle: "第六单元 古典小说",
        author: "罗贯中",
        source: "《三国演义》",
        genre: "古典小说",
        intro: "课文写刘备三次拜访诸葛亮，重点不在“请到人”本身，而在礼贤下士和人物形象塑造。预习时梳理拜访过程，比较刘备、张飞、诸葛亮的性格。",
        dictationWords: ["拜谒", "侥幸", "纶巾", "鹤氅", "愧赧", "如雷贯耳", "顿开茅塞", "箪食壶浆", "经世奇才", "思贤若渴"],
        keyPoints: ["情节概括", "人物形象", "古白话词语", "礼贤主题"],
        readingFocus: ["三顾情节的反复与推进", "刘备的诚意如何表现", "诸葛亮出场前的铺垫"],
        readingQuestions: ["为什么作者要写“三顾”而不是一次请出？", "张飞的急躁对表现刘备有什么作用？", "诸葛亮未出场前，课文怎样铺垫其形象？"],
        writingTask: "用“侧面烘托”写一个人物出场前的 100 字铺垫。",
      }),
      chineseLesson(6, 4, "25", "刘姥姥进大观园", {
        unitTitle: "第六单元 古典小说",
        author: "曹雪芹",
        source: "《红楼梦》",
        genre: "古典小说",
        intro: "节选通过刘姥姥进入大观园的见闻和众人的笑，写出人物身份差异与场面喜剧。预习时要看语言、动作和场面调度怎样共同塑造人物，并比较不同人物的笑。",
        dictationWords: ["调停", "促狭", "筵席", "发怔", "岔气", "麈尾", "撮弄", "嬷嬷", "潇湘馆", "笑岔了气"],
        keyPoints: ["场面描写", "语言描写", "人物身份", "喜剧效果"],
        readingFocus: ["刘姥姥语言动作的喜剧性", "众人不同反应体现身份性格", "场面描写的层次"],
        readingQuestions: ["刘姥姥的言行为什么能形成喜剧效果？", "众人的笑是否完全相同？分别体现了什么？", "场面描写怎样表现大观园的复杂关系？"],
        writingTask: "写一个多人同时反应的场面，至少写出三个人不同的动作或表情。",
      }),
    ],
  },
].map((chapter, index) => ({
...
function buildChinesePreviewGuide(lessonTitle, meta, keyPoints, readingFocus) {
  const cleanTitle = stripLessonNumber(lessonTitle);
  const unitTitle = meta.unitTitle ?? "";
  const genre = meta.genre ?? "课文";
  const firstFocus = readingFocus[0] ?? keyPoints[0];
  const secondFocus = readingFocus[1] ?? keyPoints[1];
  const thirdFocus = readingFocus[2] ?? keyPoints[2];
  const guide = getChineseGuideByUnit(unitTitle, genre);

  return {
    goal: `预习《${cleanTitle}》时，先弄清${firstFocus}，再能用课文词句解释${secondFocus}，最后把${thirdFocus}转化成自己的答题语言。`,
    readingSteps: [
      `第一遍通读：只做两件事，圈出生字词和不懂句子，现代文对照课本原文，古诗文先按断句读顺。`,
      `第二遍批注：围绕“${firstFocus}”和“${secondFocus}”各找 2 处词句证据，不急着写完整答案。`,
      `第三遍回答：合上资料，用“观点 + 依据 + 作用”的顺序口头答 1 道阅读题，再回看讲解补漏。`,
    ],
    coreExplanation: [
      guide.core(firstFocus, secondFocus, thirdFocus),
      `本课不要只背结论，至少要留下 1 个词语解释、1 处原文依据和 1 句自己的概括。`,
    ],
    answerMethod: guide.method(cleanTitle, firstFocus, secondFocus),
  };
}

function getChineseGuideByUnit(unitTitle, genre) {
  if (unitTitle.includes("诗歌")) {
    return {
      core: (first, second, third) => `诗歌先读节奏和画面：${first}决定先看到什么，${second}决定情感怎样推进，${third}是答题时必须落回的中心。`,
      method: (title, first, second) => `答《${title}》诗歌题时，先说意象或句式特点，再点明它表现的情感；如果问作用，就把“${first}”“${second}”和诗人的态度连起来。`,
    };
  }
  if (unitTitle.includes("议论") || unitTitle.includes("思辨")) {
    return {
      core: (first, second, third) => `议论文先找观点，再看证据：${first}是中心入口，${second}说明作者怎样证明，${third}决定答案里的评价角度。`,
      method: (title, first, second) => `答《${title}》议论文题时，用“观点是什么 -> 用了什么材料或方法 -> 证明了什么”的三步；涉及“${first}”或“${second}”时要写清论证作用。`,
    };
  }
  if (unitTitle.includes("古诗文") || genre.includes("古")) {
    return {
      core: (first, second, third) => `古诗文先通词句，再抓主旨：${first}帮助读懂内容，${second}帮助判断写法，${third}决定翻译和赏析不能偏题。`,
      method: (title, first, second) => `答《${title}》古诗文题时，先翻译关键词，再说明画面或句式作用；遇到“${first}”“${second}”要结合原句解释，不只背现代意思。`,
    };
  }
  if (unitTitle.includes("小说")) {
    return {
      core: (first, second, third) => `小说先理情节，再看人物：${first}帮助看故事怎样推进，${second}帮助看人物怎样显形，${third}是主题判断的落点。`,
      method: (title, first, second) => `答《${title}》小说题时，先概括情节或人物状态，再引用动作、语言、环境等证据；涉及“${first}”“${second}”要写出对人物和主题的作用。`,
    };
  }
  return {
    core: (first, second, third) => `本课先从${first}进入文本，再用${second}验证理解，最后回到${third}形成自己的表达。`,
    method: (title, first, second) => `答《${title}》阅读题时，用“观点 + 依据 + 作用”组织答案，依据必须来自“${first}”或“${second}”相关词句。`,
  };
}

function buildChineseReadingExplanations(lessonTitle, meta, questions, readingFocus) {
  const cleanTitle = stripLessonNumber(lessonTitle);
  const focus = readingFocus.length ? readingFocus : ["文本内容", "表达方法", "主题情感"];

  return questions.map((question, index) => {
    const currentFocus = focus[index % focus.length];
    const nextFocus = focus[(index + 1) % focus.length];
    return {
      question,
      thinking: buildChineseQuestionThinking(meta.unitTitle, cleanTitle, question, currentFocus, nextFocus),
      sampleAnswer: buildChineseSampleAnswer(meta.unitTitle, cleanTitle, currentFocus, nextFocus),
    };
  });
}

function buildChineseQuestionThinking(unitTitle, cleanTitle, question, currentFocus, nextFocus) {
  if (unitTitle.includes("诗歌")) {
    return `先找题干对应的意象、反复句或情感词，再判断它把“${currentFocus}”推向了怎样的情绪。`;
  }
  if (unitTitle.includes("议论") || unitTitle.includes("思辨")) {
    return `先判断题目问的是观点、论据还是论证方法，再说明它怎样服务“${currentFocus}”。`;
  }
  if (unitTitle.includes("古诗文")) {
    return `先把题干中的关键词翻译准确，再回到原句，看它和“${currentFocus}”的关系。`;
  }
  if (unitTitle.includes("小说")) {
    return `先定位相关情节或细节，再看人物状态如何变化，并把答案落到“${currentFocus}”。`;
  }
  return `先定位《${cleanTitle}》中的相关词句，再用“内容 + 写法 + 作用”说明“${currentFocus}”。`;
}

function buildChineseSampleAnswer(unitTitle, cleanTitle, currentFocus, nextFocus) {
  if (unitTitle.includes("诗歌")) {
    return `可从“${currentFocus}”切入，选取具体意象或句式，说明它怎样表现诗人的情绪，并联系“${nextFocus}”收束。`;
  }
  if (unitTitle.includes("议论") || unitTitle.includes("思辨")) {
    return `可先概括作者观点，再指出材料或方法的作用：它使“${currentFocus}”更有说服力，并把文章推进到“${nextFocus}”。`;
  }
  if (unitTitle.includes("古诗文")) {
    return `可先解释关键词，再翻译相关句子，最后说明这句话表现了“${currentFocus}”，并和“${nextFocus}”相连。`;
  }
  if (unitTitle.includes("小说")) {
    return `可先概括情节变化，再引用人物语言、动作或环境细节，说明它表现“${currentFocus}”，推动读者理解“${nextFocus}”。`;
  }
  return `可围绕“${currentFocus}”先答结论，再补 1 处课文词句依据，最后说明对“${nextFocus}”的表达作用。`;
}
...
function buildPhysicsChapterTieredPractice(chapter) {
  const bank = {
    "phy-chapter-11": {
      goals: {
        基础: "会判断杠杆、滑轮、做功和功率的基本条件",
        巩固: "会用杠杆平衡、功和功率公式完成计算",
        挑战: "会综合机械效率、滑轮组和做功条件分析情境",
      },
      questions: {
        基础: [
          physicsTierQuestion("杠杆力臂", "如图撬棒绕 O 点转动，手在 A 点竖直向下用力。动力臂应是哪一段距离？", "O 点到动力作用线的垂直距离", "力臂是支点到力的作用线的垂直距离，不是 OA 的长度。", "把 O 到 A 的斜线段当成力臂。"),
          physicsTierQuestion("做功条件", "小明用 50N 的水平推力推箱子，箱子沿水平地面前进 2m。推力做功多少？", "100J", "推力方向和位移方向一致，W=Fs=50×2=100J。", "只写有力，却漏看是否沿力方向移动。"),
        ],
        巩固: [
          physicsTierQuestion("杠杆平衡", "杠杆水平平衡，左端挂 30N 物体，力臂 0.2m；右端力臂 0.6m。右端至少需要多大竖直拉力？", "10N", "由 F1L1=F2L2，30×0.2=F×0.6，所以 F=10N。", "把长力臂一侧的力反而算大。"),
          physicsTierQuestion("功率计算", "起重机 20s 内把 500N 的重物匀速提升 4m，起重机对重物做功的功率是多少？", "100W", "W=Gh=500×4=2000J，P=W/t=2000÷20=100W。", "只算出功 2000J，没有再除以时间。"),
        ],
        挑战: [
          physicsTierQuestion("滑轮组效率", "用滑轮组把 120N 的物体提升 2m，绳端拉力做的总功为 300J，机械效率是多少？", "80%", "有用功 W有=Gh=120×2=240J，η=W有/W总=240÷300=80%。", "把总功和有用功的位置写反。"),
          physicsTierQuestion("滑轮组绳段", "用滑轮组提升物体，物体上升 0.3m，绳端移动 0.9m。不计摩擦时，承担重物的绳子段数是多少？", "3 段", "理想滑轮组 s=nh，0.9=n×0.3，得 n=3。", "只数滑轮个数，不用绳端移动距离判断。"),
        ],
      },
    },
    "phy-chapter-12": {
      goals: {
        基础: "会判断动能、势能、内能和热传递方向",
        巩固: "会用比热容公式和能量转化解释现象",
        挑战: "会分析实验变量和机械能、内能综合变化",
      },
      questions: {
        基础: [
          physicsTierQuestion("动能因素", "同一辆小车从更高的斜面处滑下，撞击木块后木块移动更远，主要说明小车哪种能量变大？", "动能变大", "高度更高时到达水平面速度更大，同一小车质量相同，动能随速度增大而增大。", "只看斜面高度，没落到速度和动能。"),
          physicsTierQuestion("热传递方向", "一杯 80℃ 的热水和一块 20℃ 的金属勺接触，热量主要从哪一方传向哪一方？", "从热水传向金属勺", "热传递方向是从高温物体传向低温物体。", "把温度低的物体说成主动放热。"),
        ],
        巩固: [
          physicsTierQuestion("比热容计算", "2kg 水温度升高 5℃，c水=4.2×10³J/(kg·℃)，水吸收多少热量？", "4.2×10⁴J", "Q=cmΔt=4.2×10³×2×5=4.2×10⁴J。", "漏乘质量或把温度变化写成末温。"),
          physicsTierQuestion("内能改变", "用打气筒给自行车胎打气，筒壁变热，主要说明哪种方式能改变内能？", "做功", "压缩空气时外力对气体做功，机械能转化为内能。", "看到变热就只想到热传递。"),
        ],
        挑战: [
          physicsTierQuestion("吸热实验", "比较水和煤油吸热能力时，两烧杯液体质量相同、加热器相同。若水升温慢，说明水的什么物理量较大？", "比热容较大", "吸收相同热量、质量相同，温度升高越小，比热容越大。", "没有控制质量和吸热时间就比较结论。"),
          physicsTierQuestion("机械能转化", "过山车从高处无动力下滑，不计阻力时，高度降低、速度增大，主要是哪两种机械能相互转化？", "重力势能转化为动能", "高度降低使重力势能减小，速度增大使动能增大。", "只写速度变快，不说明能量来源。"),
        ],
      },
    },
    "phy-chapter-13": {
      goals: {
        基础: "会判断电路状态、电流表和电压表连接方式",
        巩固: "会分析串并联电路中的电流和电压关系",
        挑战: "会处理电路故障、量程和安全问题",
      },
      questions: {
        基础: [
          physicsTierQuestion("短路判断", "导线直接连接电源两极，中间没有灯泡等用电器，这种电路状态叫什么？", "短路", "短路时电流很大，可能损坏电源或导线。", "把没有电流的断路和电流过大的短路混淆。"),
          physicsTierQuestion("电表接法", "测量小灯泡两端电压时，电压表应与小灯泡怎样连接？", "并联", "电压表测两点间电压，要并联在被测元件两端。", "把电压表接成串联，导致电路不能正常工作。"),
        ],
        巩固: [
          physicsTierQuestion("并联电流", "并联电路中两支路电流分别为 0.2A 和 0.3A，干路电流是多少？", "0.5A", "并联电路干路电流等于各支路电流之和，I=0.2A+0.3A=0.5A。", "把并联电流误认为各处都相等。"),
          physicsTierQuestion("串联电压", "串联电路中两个小灯泡两端电压分别为 2V 和 4V，电源电压是多少？", "6V", "串联电路总电压等于各部分电压之和。", "把串联电压误认为平均分。"),
        ],
        挑战: [
          physicsTierQuestion("电路故障", "串联电路中灯 L1、L2 都不亮，电流表无示数，电压表并在 L1 两端有示数，L1 最可能发生什么故障？", "断路", "电流表无示数说明电路断开；电压表并在 L1 两端有示数，断点可能在 L1。", "看到电压表有示数就误判灯泡正常。"),
          physicsTierQuestion("电流表量程", "估计电路电流可能接近 0.8A，电流表有 0-0.6A 和 0-3A 两个量程，首次试触应选哪个量程？", "0-3A 量程", "不能确定或可能超过小量程时，先用大量程保护电流表。", "直接用小量程导致指针打满。"),
        ],
      },
    },
    "phy-chapter-14": {
      goals: {
        基础: "会判断电阻因素、变阻器接法和欧姆定律基本量",
        巩固: "会计算电阻、电流和串并联等效电阻",
        挑战: "会分析动态电路和欧姆定律实验图像",
      },
      questions: {
        基础: [
          physicsTierQuestion("影响电阻因素", "同种材料、长度相同的两根导线，横截面积较大的导线电阻通常怎样？", "较小", "导线越粗，电流通过越容易，电阻越小。", "只看长度，忽略横截面积。"),
          physicsTierQuestion("变阻器接法", "滑动变阻器接入电路并能改变亮度时，通常应接哪两个接线柱？", "一上一下", "一上一下接法才能改变接入电路的电阻丝长度。", "把两个上端或两个下端接入，变阻效果不对。"),
        ],
        巩固: [
          physicsTierQuestion("欧姆定律", "某电阻两端电压为 6V，通过电流为 0.3A，该电阻是多少？", "20Ω", "R=U/I=6÷0.3=20Ω。", "把电压和电流相乘，或漏写 Ω。"),
          physicsTierQuestion("串并联电阻", "两个 10Ω 电阻串联，总电阻是多少？若并联，总电阻是多少？", "串联 20Ω，并联 5Ω", "串联电阻相加；两个相同电阻并联，总电阻为单个的一半。", "把串联和并联的等效电阻规律写反。"),
        ],
        挑战: [
          physicsTierQuestion("动态电路", "电源电压不变，定值电阻与滑动变阻器串联。滑片移动后接入电阻变大，电路中电流怎样变化？", "变小", "串联总电阻变大，由 I=U/R 可知电流变小。", "只看滑片移动方向，不判断接入电阻变化。"),
          physicsTierQuestion("U-I 图像", "定值电阻的 U-I 图像过原点，U=4V 时 I=0.2A；当 U=8V 时 I 是多少？", "0.4A", "定值电阻不变，电流与电压成正比，电压加倍电流也加倍。", "把图像斜率和电阻关系混淆。"),
        ],
      },
    },
  };
  const selected = bank[chapter.id] ?? bank["phy-chapter-11"];
...
function physicsTierQuestion(concept, question, answer, explanation, trap) {
  return {
    concept,
    question,
    answer,
...
function buildChapterTieredPractice(subjectId, chapter) {
  ...
  if (subjectId === "physics") {
    return buildPhysicsChapterTieredPractice(chapter);
  }
...
function buildChemistryPracticeSet(chapter, lessonItem) {
  const bank = {
    ...
    "chem-3-1": [
      ...
      chemistryPractice("巩固", "分子运动实验", "把一小粒品红放入静置的水中，水逐渐变红，主要说明什么？", ["分子在不断运动", "水分子变成品红分子", "品红消失了"], "分子在不断运动", "品红分子不断运动并扩散到水中，所以整杯水逐渐变红。", "把扩散现象误认为发生了化学反应。", { type: "experiment" }),
      chemistryPractice("提升", "微粒观综合", "用微粒观点解释“水蒸发”和“水电解”的区别，下列说法正确的是？", ["水蒸发时分子间隔变大，水电解时水分子分解成新的微粒", "两者都只是分子间隔改变", "两者都没有微粒变化"], "水蒸发时分子间隔变大，水电解时水分子分解成新的微粒", "物理变化中分子本身不变，化学变化中分子发生改变并生成新物质。", "只记现象，不从分子是否改变判断。", { type: "comprehensive" }),
    ],
    "chem-3-2": [
    ...
    "chem-4-2": [
      ...
      chemistryPractice("基础", "质量守恒填空", "化学反应前后，原子的种类、数目和______不变。", ["质量", "颜色", "状态"], "质量", "质量守恒的微观原因是原子种类、数目和质量在反应前后不变。", "把反应现象的颜色变化也当成守恒内容。", { type: "blank" }),
      chemistryPractice("提升", "质量守恒综合", "镁条在空气中燃烧后生成氧化镁，固体质量比原镁条变大。这个现象是否违背质量守恒定律？", ["不违背，因为氧气参加反应并进入生成物", "违背，因为固体质量变大", "无法判断，因为有白光"], "不违背，因为氧气参加反应并进入生成物", "称量固体时只称了部分反应物和生成物，氧气来自空气；若把参加反应的氧气也计入，总质量守恒。", "只看固体质量变化，不看气体是否参加反应。", { type: "comprehensive" }),
    ],
    "chem-4-3": [
    ...
    "chem-5-1": [
      ...
      chemistryPractice("基础", "金属活动性填空", "镁、锌、铁与稀盐酸反应都能产生______气。", ["氢", "氧", "氮"], "氢", "活泼金属与稀盐酸反应通常生成盐和氢气。", "把酸中含氧误认为一定生成氧气。", { type: "blank" }),
    ],
    "chem-5-2": [
      ...
      chemistryPractice("巩固", "炼铁计算", "反应 Fe₂O₃ + 3CO = 2Fe + 3CO₂ 中，160 份质量的 Fe₂O₃ 完全反应理论上可生成多少份质量的 Fe？", ["112", "56", "160"], "112", "Fe₂O₃ 的相对式量为 160，生成 2Fe 的相对质量为 2×56=112。", "只看到一个 Fe 就写 56，漏掉化学计量数 2。", { type: "calculation" }),
      chemistryPractice("提升", "炼铁实验综合", "用 CO 还原氧化铁实验中，尾气应点燃或收集处理，主要原因是什么？", ["CO 有毒且可燃，不能直接排入空气", "CO₂ 有毒必须燃烧", "铁粉会挥发"], "CO 有毒且可燃，不能直接排入空气", "CO 是有毒气体，实验尾气需要处理；点燃可把 CO 转化为 CO₂。", "只关注生成铁，忽略尾气安全。", { type: "comprehensive" }),
    ],
    "chem-5-3": [
  ...
  const extras = {
    "chem-1-1": [
      chemistryPractice("基础", "化学变化", "蜡烛燃烧生成二氧化碳和水，说明蜡烛燃烧属于______变化。", ["化学", "物理", "状态"], "化学", "有新物质二氧化碳和水生成，所以属于化学变化。", "只看到蜡烛变短，忽略生成物。", { type: "blank" }),
      chemistryPractice("提升", "变化判断综合", "把纸撕碎和纸燃烧相比，判断纸燃烧是化学变化的关键证据是什么？", ["生成灰烬等新物质", "纸的形状变小", "纸的位置改变"], "生成灰烬等新物质", "撕碎只改变形状，燃烧生成新物质，是判断化学变化的关键。", "把形状改变也当成化学变化。", { type: "comprehensive" }),
    ],
    "chem-1-2": [
      chemistryPractice("基础", "物理性质", "通常状况下氧气是无色气体，这属于氧气的______性质。", ["物理", "化学", "酸性"], "物理", "颜色和状态不需要通过化学变化表现，属于物理性质。", "把物质性质全部归成化学性质。", { type: "blank" }),
      chemistryPractice("提升", "性质用途综合", "氮气常用于食品防腐，主要利用氮气化学性质不活泼。这个例子说明什么关系？", ["性质决定用途", "用途决定元素种类", "颜色决定反应速度"], "性质决定用途", "氮气不易与食品成分反应，因此能用于充氮防腐。", "只背用途，不会说对应性质。", { type: "comprehensive" }),
    ],
    "chem-1-3": [
      chemistryPractice("基础", "实验记录", "观察铜片加热实验时，“铜片表面变黑”属于实验______。", ["现象", "结论", "仪器"], "现象", "现象是看得见、测得到的变化；生成了氧化铜才是进一步分析出的结论。", "把现象和结论混写。", { type: "blank" }),
      chemistryPractice("巩固", "实验安全", "给试管中液体加热时，试管口不能朝向人的原因是什么？", ["防止液体暴沸喷出伤人", "让反应更快", "让颜色更明显"], "防止液体暴沸喷出伤人", "加热液体可能暴沸，试管口不能对着自己或他人。", "只记操作，不懂安全原因。", { type: "experiment" }),
    ],
    "chem-2-1": [
      chemistryPractice("巩固", "空气成分填空", "空气中氧气约占空气体积的______。", ["1/5", "4/5", "78%"], "1/5", "红磷燃烧实验和空气成分都指向氧气约占 1/5。", "把氮气体积分数和氧气体积分数混淆。", { type: "blank" }),
      chemistryPractice("提升", "红磷实验误差", "红磷燃烧测空气中氧气含量时，若装置漏气，水面上升结果通常会怎样？", ["偏小或不稳定", "一定偏大", "没有任何影响"], "偏小或不稳定", "装置漏气会使外界空气进入，压强变化不明显，测得氧气体积分数偏小或不稳定。", "只背 1/5，不分析误差来源。", { type: "experiment" }),
    ],
    "chem-2-2": [
      chemistryPractice("巩固", "氧气性质填空", "氧气能支持燃烧，但氧气本身______。", ["不能燃烧", "容易燃烧", "能变成燃料"], "不能燃烧", "氧气支持燃烧，但不属于可燃物。", "把助燃性误写成可燃性。", { type: "blank" }),
    ],
    "chem-2-3": [
      chemistryPractice("提升", "制氧综合", "用高锰酸钾制氧气并用排水法收集，实验结束顺序正确的是哪一项？", ["先移出导管，再熄灭酒精灯", "先熄灭酒精灯，再移出导管", "先把试管口朝上"], "先移出导管，再熄灭酒精灯", "先移导管可以防止水倒吸进入热试管造成炸裂。", "实验结束顺序颠倒。", { type: "experiment" }),
    ],
    "chem-2-4": [
      chemistryPractice("提升", "净水综合", "过滤后的水仍可能含有可溶性杂质，若要获得较纯净的水，通常还需哪种方法？", ["蒸馏", "静置", "用漏斗再过滤一次"], "蒸馏", "过滤只能除去不溶性固体，蒸馏能除去多数可溶性杂质。", "误以为过滤能得到纯净水。", { type: "comprehensive" }),
    ],
    "chem-2-5": [
      chemistryPractice("提升", "氧气性质实验", "做铁丝在氧气中燃烧实验时，若铁丝没有燃烧，可能原因不包括哪一项？", ["集气瓶底放了少量水", "铁丝未打磨除锈", "氧气浓度不足"], "集气瓶底放了少量水", "瓶底放水是保护集气瓶，不会直接导致铁丝不燃烧；铁丝未除锈或氧气不纯会影响燃烧。", "把安全措施误当失败原因。", { type: "experiment" }),
    ],
  }[lessonItem.id] ?? [];

  return [...questions, ...extras].map((question, index) => ({
    id: `${lessonItem.id}-practice-${index + 1}`,
    subject: "chemistry",
    lessonId: lessonItem.id,
    chapterId: chapter.id,
...
function buildPhysicsPracticeSet(chapter, lessonItem) {
  const bank = {
    "phy-11-1": [
      physicsPractice("基础", "杠杆五要素", "如图所示撬棒撬石块，支点为 O。关于动力臂，下列说法正确的是哪一项？", ["动力臂是 O 到动力作用线的垂直距离", "动力臂是 O 到手的距离", "动力臂一定等于撬棒长度"], "动力臂是 O 到动力作用线的垂直距离", "力臂是支点到力的作用线的垂直距离，不是支点到作用点的线段。", "把力臂画成斜边。", { type: "choice" }),
      physicsPractice("巩固", "杠杆平衡", "杠杆在水平位置平衡，动力为 20N、动力臂为 0.6m，阻力臂为 0.2m，阻力是多少？", ["60N", "6.7N", "20N"], "60N", "由 F₁L₁=F₂L₂，20×0.6=F₂×0.2，F₂=60N。", "把两个力臂代反。", { type: "calculation" }),
      physicsPractice("巩固", "省力杠杆", "下列工具中，正常使用时属于省力杠杆的是哪一个？", ["羊角锤拔钉", "镊子夹物", "钓鱼竿提鱼"], "羊角锤拔钉", "羊角锤拔钉时动力臂大于阻力臂，能省力；镊子和钓鱼竿多为费力杠杆。", "只看工具形状，不比较力臂长短。", { type: "choice" }),
      physicsPractice("提升", "杠杆综合", "用杠杆吊起 120N 物体，阻力臂 0.15m，若动力臂为 0.45m，不计杠杆自重，至少需要多大动力？", ["40N", "60N", "360N"], "40N", "F×0.45=120×0.15，F=40N。动力臂是阻力臂的 3 倍，所以动力为阻力的 1/3。", "只按距离比例写反。", { type: "comprehensive" }),
    ],
    "phy-11-2": [
      physicsPractice("基础", "定滑轮", "升旗杆顶端常装定滑轮，主要作用是什么？", ["改变拉力方向", "省一半的力", "减少旗帜重力"], "改变拉力方向", "定滑轮相当于等臂杠杆，不能省力，但能改变力的方向。", "把所有滑轮都理解成省力。", { type: "choice" }),
      physicsPractice("巩固", "动滑轮", "不计摩擦和动滑轮重，用一个动滑轮匀速提升 100N 物体，拉力约为多少？", ["50N", "100N", "200N"], "50N", "动滑轮由两段绳子承担重物，理想情况下 F=G/2=50N。", "忘记前提是不计动滑轮重和摩擦。", { type: "calculation" }),
      physicsPractice("巩固", "滑轮组绳段数", "滑轮组中有 3 段绳子承担重物，物重 150N，不计摩擦和滑轮重，拉力为多少？", ["50N", "75N", "450N"], "50N", "理想滑轮组 F=G/n=150÷3=50N。", "把自由端也随意计入或漏数承重绳段。", { type: "calculation" }),
      physicsPractice("提升", "滑轮组综合", "用滑轮组把重物升高 0.2m，绳端移动 0.6m，说明承担重物的绳子段数是几段？", ["3 段", "2 段", "6 段"], "3 段", "理想关系 s=nh，0.6= n×0.2，所以 n=3。", "只看滑轮个数，不用绳端移动距离判断。", { type: "comprehensive" }),
    ],
    "phy-11-3": [
      physicsPractice("基础", "做功条件", "下列情境中，人对物体做了功的是哪一项？", ["用水平力推箱子前进 3m", "举着书不动", "提着书水平匀速走路时提力对书做功"], "用水平力推箱子前进 3m", "做功需要有力，并且物体在力的方向上通过距离。", "有力不一定做功，还要看力方向上的位移。", { type: "choice" }),
      physicsPractice("基础", "功的公式填空", "在力 F 与物体移动距离 s 方向一致时，功的计算式是 W = ______。", ["Fs", "F/s", "s/F"], "Fs", "功等于力和物体在力方向上移动距离的乘积，单位是 J。", "把乘法写成除法，或忽略力与位移方向。", { type: "blank" }),
      physicsPractice("巩固", "功的计算", "用 20N 的水平推力使小车在水平地面前进 5m，推力做功多少？", ["100J", "4J", "25J"], "100J", "W=Fs=20×5=100J。", "漏写单位 J，或把力和距离相除。", { type: "calculation" }),
      physicsPractice("巩固", "重力做功", "质量为 2kg 的物体被提升 3m，取 g=10N/kg，克服重力做功多少？", ["60J", "6J", "20J"], "60J", "重力 G=mg=20N，克服重力做功 W=Gh=20×3=60J。", "没有先求重力。", { type: "calculation" }),
      physicsPractice("提升", "功的综合判断", "背着书包水平匀速走路时，支持书包的力对书包是否做功？", ["不做功，因为书包没有在该力方向上移动", "做功，因为人很累", "做功，因为书包有重力"], "不做功，因为书包没有在该力方向上移动", "支持力方向竖直向上，书包位移方向水平，力方向上没有位移，所以该力不做功。", "把人的疲劳感当成物理做功。", { type: "comprehensive" }),
    ],
    "phy-11-4": [
      physicsPractice("基础", "功率意义", "两台机器做相同的功，甲用时 5s，乙用时 10s。哪台功率大？", ["甲", "乙", "一样大"], "甲", "功率表示做功快慢，做功相同，用时越短功率越大。", "把功率当成功的多少。", { type: "choice" }),
      physicsPractice("巩固", "功率计算", "某机器 10s 做功 800J，功率是多少？", ["80W", "8000W", "0.0125W"], "80W", "P=W/t=800÷10=80W。", "把时间和功的位置代反。", { type: "calculation" }),
      physicsPractice("巩固", "单位换算", "0.6kW 等于多少 W？", ["600W", "60W", "6000W"], "600W", "1kW=1000W，所以 0.6kW=600W。", "千瓦和瓦换算倍数写错。", { type: "calculation" }),
      physicsPractice("提升", "功率综合", "起重机把 500N 的物体匀速提升 4m，用时 20s，功率是多少？", ["100W", "2000W", "25W"], "100W", "先算功 W=Gh=500×4=2000J，再算 P=W/t=2000÷20=100W。", "只算功，没有再除以时间。", { type: "comprehensive" }),
    ],
    "phy-11-5": [
      physicsPractice("基础", "机械效率", "关于机械效率，下列说法正确的是哪一项？", ["机械效率等于有用功与总功之比", "机械效率可能大于 100%", "额外功越多效率越高"], "机械效率等于有用功与总功之比", "机械效率 η=W有用/W总×100%，实际机械有额外功，所以小于 100%。", "把效率和功率混淆。", { type: "choice" }),
      physicsPractice("巩固", "滑轮组效率计算", "用滑轮组把 100N 物体提升 2m，拉力做总功 250J，机械效率是多少？", ["80%", "125%", "50%"], "80%", "有用功 W有=Gh=100×2=200J，η=200÷250×100%=80%。", "把总功和有用功的位置写反。", { type: "calculation" }),
      physicsPractice("巩固", "额外功", "使用机械提升物体时，额外功主要可能来自哪一项？", ["机械自重和摩擦", "物体受到的重力消失", "有用功变成 0"], "机械自重和摩擦", "动滑轮重、绳重和摩擦都会消耗额外功。", "认为机械越复杂效率必然越高。", { type: "choice" }),
      physicsPractice("提升", "效率综合", "某滑轮组有用功 300J，机械效率 75%，总功是多少？", ["400J", "225J", "75J"], "400J", "η=W有/W总，W总=300÷0.75=400J。", "百分数没有化成小数。", { type: "comprehensive" }),
    ],
    "phy-14-1": [
      physicsPractice("基础", "影响电阻因素", "同种材料的导线，长度相同，横截面积越大，电阻通常怎样变化？", ["越小", "越大", "不变"], "越小", "导体越粗，电流通过越容易，电阻越小。", "只看长度，不看横截面积。", { type: "choice" }),
      physicsPractice("巩固", "电阻属性", "对同一段金属导体，下列说法正确的是哪一项？", ["电阻主要由材料、长度、横截面积和温度决定", "电压越大电阻一定越大", "电流越大电阻一定越小"], "电阻主要由材料、长度、横截面积和温度决定", "电阻是导体本身属性，在温度不变时不由电压电流直接决定。", "把 R=U/I 误解成电阻由电压电流决定。", { type: "choice" }),
      physicsPractice("巩固", "控制变量", "探究长度对电阻的影响时，应保持哪两项相同？", ["材料和横截面积", "长度和材料", "长度和电压"], "材料和横截面积", "研究一个因素时，其他可能影响电阻的因素要保持相同。", "控制变量漏掉横截面积。", { type: "experiment" }),
      physicsPractice("提升", "电阻综合", "甲、乙两根铜导线粗细相同，甲长 1m，乙长 2m。温度相同，哪根电阻较大？", ["乙", "甲", "一样大"], "乙", "材料、横截面积相同，长度越长电阻越大。", "忽略题干中的“粗细相同”。", { type: "comprehensive" }),
    ],
    "phy-14-2": [
      physicsPractice("基础", "滑动变阻器接法", "滑动变阻器接入电路时，通常应选择哪种接法？", ["一上一下", "只接两个上端", "只接两个下端"], "一上一下", "一上一下才能改变接入电路的电阻丝长度。", "两个接线柱接在同一侧导致不能有效变阻。", { type: "choice" }),
      physicsPractice("巩固", "保护电路", "闭合开关前，滑动变阻器滑片应放在什么位置？", ["阻值最大处", "阻值最小处", "任意位置"], "阻值最大处", "最大阻值可限制电流，保护电路和电表。", "一闭合就用最小电阻，容易电流过大。", { type: "experiment" }),
      physicsPractice("巩固", "电流变化", "串联电路中滑动变阻器接入电阻变大，电源电压不变，总电流通常怎样变化？", ["变小", "变大", "不变"], "变小", "总电阻变大，由 I=U/R 可知电流变小。", "只看滑片方向，不判断接入电阻变化。", { type: "calculation" }),
      physicsPractice("提升", "变阻器综合", "滑动变阻器铭牌“20Ω 1A”表示什么？", ["最大电阻 20Ω，允许通过最大电流 1A", "电压一定是 20V", "功率一定是 1W"], "最大电阻 20Ω，允许通过最大电流 1A", "铭牌给出最大阻值和允许通过的最大电流，实验时不能超过。", "把 Ω 和 A 的含义混淆。", { type: "comprehensive" }),
    ],
    "phy-14-3": [
      physicsPractice("基础", "欧姆定律计算", "某电阻两端电压为 6V，通过电流为 0.3A，该电阻为多少？", ["20Ω", "1.8Ω", "0.05Ω"], "20Ω", "R=U/I=6÷0.3=20Ω。", "没有统一单位或把 U 与 I 相乘。", { type: "calculation" }),
      physicsPractice("基础", "欧姆定律填空", "欧姆定律可写成 I = ______。", ["U/R", "UR", "R/U"], "U/R", "通过导体的电流等于导体两端电压除以电阻。", "把除法写成乘法，或把电阻放到分子。", { type: "blank" }),
      physicsPractice("巩固", "电流计算", "10Ω 电阻接在 3V 电源两端，通过它的电流是多少？", ["0.3A", "30A", "13A"], "0.3A", "I=U/R=3÷10=0.3A。", "把除法写成乘法。", { type: "calculation" }),
      physicsPractice("巩固", "实验控制变量", "探究电流与电压关系时，应保持哪一项不变？", ["电阻", "电压", "电流"], "电阻", "研究 I 与 U 的关系，要控制导体电阻不变。", "控制变量对象写反。", { type: "experiment" }),
      physicsPractice("提升", "欧姆定律图像", "某定值电阻的 U-I 图像为过原点直线，若 U=4V 时 I=0.2A，则 U=8V 时 I 为多少？", ["0.4A", "0.1A", "1.6A"], "0.4A", "定值电阻电流与电压成正比，电压加倍，电流也加倍。", "不识别定值电阻的正比例关系。", { type: "comprehensive" }),
    ],
    "phy-14-4": [
      physicsPractice("基础", "串联电阻", "两个 10Ω 电阻串联，总电阻是多少？", ["20Ω", "5Ω", "10Ω"], "20Ω", "串联电阻相加，R总=10+10=20Ω。", "把串联误算成并联。", { type: "calculation" }),
      physicsPractice("巩固", "并联电阻", "两个 10Ω 电阻并联，总电阻是多少？", ["5Ω", "20Ω", "10Ω"], "5Ω", "两个相同电阻并联，总电阻为单个电阻的一半。", "把并联电阻直接相加。", { type: "calculation" }),
      physicsPractice("巩固", "故障判断", "串联电路中灯泡不亮，电流表示数为 0，电压表并在某灯两端有示数，该灯可能发生什么故障？", ["断路", "短路", "正常发光"], "断路", "串联电路电流为 0 表示电路断开，电压表有示数说明断点可能在被测灯处。", "把有电压表示数误判为灯正常。", { type: "comprehensive" }),
      physicsPractice("提升", "动态电路", "电源电压不变，定值电阻与滑动变阻器串联。滑动变阻器接入电阻变大，电路总电流怎样变化？", ["变小", "变大", "不变"], "变小", "串联总电阻变大，由 I=U/R 可知总电流变小。", "只看局部电压变化，忘了先看总电阻。", { type: "comprehensive" }),
    ],
  };

  const fallbackByLesson = {
    "phy-12-1": [
      physicsPractice("基础", "动能", "同一辆小车，速度越大，撞击木块后木块移动距离通常怎样变化？", ["越大", "越小", "不变"], "越大", "速度越大，小车动能越大，对木块做功越多。", "只看质量不看速度。", { type: "experiment" }),
      physicsPractice("巩固", "重力势能", "质量相同的两物体，高度越高，重力势能通常怎样变化？", ["越大", "越小", "不变"], "越大", "重力势能与质量和高度有关，质量相同时高度越高势能越大。", "把高度和速度混在一起。", { type: "choice" }),
      physicsPractice("提升", "机械能转化", "过山车从高处下滑时，不计阻力，主要发生哪种能量转化？", ["重力势能转化为动能", "动能转化为化学能", "内能转化为电能"], "重力势能转化为动能", "高度降低、速度增大，重力势能减少，动能增加。", "只看速度变化，不说能量来源。", { type: "comprehensive" }),
    ],
    "phy-12-2": [
      physicsPractice("基础", "热传递方向", "热水和冷水接触时，热量通常从哪一方传向哪一方？", ["热水传向冷水", "冷水传向热水", "两边都不传"], "热水传向冷水", "热传递方向总是从高温物体到低温物体。", "说物体“含有热量”。", { type: "choice" }),
      physicsPractice("巩固", "内能改变", "冬天搓手变热主要通过哪种方式改变手的内能？", ["做功", "热传递", "蒸发"], "做功", "摩擦做功使机械能转化为内能。", "看到温度升高就只想到热传递。", { type: "choice" }),
      physicsPractice("提升", "温度和内能", "一杯水温度升高，它的内能通常怎样变化？", ["增大", "减小", "一定不变"], "增大", "温度升高表示分子热运动更剧烈，水的内能通常增大。", "把内能和温度完全等同。", { type: "comprehensive" }),
    ],
    "phy-12-3": [
      physicsPractice("基础", "比热容计算", "2kg 水温度升高 5℃，c水=4.2×10³J/(kg·℃)，吸收热量是多少？", ["4.2×10⁴J", "4.2×10³J", "10J"], "4.2×10⁴J", "Q=cmΔt=4.2×10³×2×5=4.2×10⁴J。", "把 Δt 写成质量或漏乘质量。", { type: "calculation" }),
      physicsPractice("基础", "吸热公式填空", "物体吸收热量的计算式 Q = ______。", ["cmΔt", "m/c", "c/Δt"], "cmΔt", "吸放热计算常用 Q=cmΔt，其中 c 是比热容，m 是质量，Δt 是温度变化。", "漏乘质量或把 Δt 当成末温。", { type: "blank" }),
      physicsPractice("巩固", "水的比热容", "沿海地区昼夜温差较小，主要利用水的哪一特点解释？", ["比热容大", "密度小", "透明"], "比热容大", "水吸放相同热量时温度变化较小。", "把比热容理解成吸热多少固定不变。", { type: "choice" }),
      physicsPractice("提升", "控制变量", "比较水和煤油吸热升温快慢时，应控制哪项相同？", ["质量和加热时间", "颜色和气味", "容器高度一定不同"], "质量和加热时间", "研究物质吸热能力，要控制质量和吸收热量相同。", "没有控制吸热条件。", { type: "experiment" }),
    ],
    "phy-12-4": [
      physicsPractice("基础", "能量转化", "汽油机做功冲程中，主要能量转化是哪一项？", ["内能转化为机械能", "机械能转化为内能", "电能转化为光能"], "内能转化为机械能", "燃气膨胀推动活塞做功，把内能转化为机械能。", "把热机每个冲程的能量转化混淆。", { type: "choice" }),
      physicsPractice("巩固", "做功改变内能", "压缩空气使空气温度升高，说明什么方式可以改变内能？", ["做功", "蒸发", "凝固"], "做功", "外力压缩空气对空气做功，空气内能增大。", "只把加热看作改变内能方式。", { type: "experiment" }),
      physicsPractice("提升", "能量守恒", "摩擦生热时，机械能减少后主要转化为什么？", ["内能", "质量", "电阻"], "内能", "摩擦过程中机械能转化为物体内能，能量总量守恒。", "认为能量凭空消失。", { type: "comprehensive" }),
    ],
    "phy-13-1": [
      physicsPractice("基础", "电路状态", "导线直接连接电源两极，绕过用电器，这种状态称为什么？", ["短路", "通路", "断路"], "短路", "短路时电流很大，可能损坏电源。", "把短路和断路混淆。", { type: "choice" }),
      physicsPractice("巩固", "完整电路", "一个最简单的闭合电路通常必须包含电源、开关、导线和什么？", ["用电器", "电压表", "磁铁"], "用电器", "用电器把电能转化为其他形式能量，是电路工作对象。", "只画导线和电源造成短路。", { type: "blank" }),
      physicsPractice("提升", "电路安全", "连接电路时，闭合开关前应先检查什么？", ["是否存在短路", "灯泡颜色是否好看", "导线是否越长越好"], "是否存在短路", "短路会造成过大电流，实验前必须避免。", "先闭合再检查。", { type: "experiment" }),
    ],
    "phy-13-2": [
      physicsPractice("基础", "串联电路", "串联电路中，用电器之间的关系通常是怎样的？", ["相互影响", "完全互不影响", "电压一定为 0"], "相互影响", "串联电路只有一条电流路径，一个用电器断开会影响整个电路。", "只看元件摆放位置，不沿电流路径分析。", { type: "choice" }),
      physicsPractice("巩固", "并联电路", "家庭电路中各用电器通常采用哪种连接方式？", ["并联", "串联", "短路"], "并联", "并联各支路相对独立，能单独工作。", "把多个用电器都接在电路中就认为是串联。", { type: "choice" }),
      physicsPractice("提升", "开关控制", "并联电路中，支路开关通常控制哪一部分？", ["所在支路", "所有支路", "电源内部"], "所在支路", "支路开关只改变该支路的通断，不影响其他并联支路。", "没有分清干路和支路。", { type: "comprehensive" }),
    ],
    "phy-13-3": [
      physicsPractice("基础", "电流表接法", "测量通过小灯泡的电流，电流表应怎样接入？", ["与小灯泡串联", "与小灯泡并联", "直接接电源两端"], "与小灯泡串联", "电流表测通过某元件的电流，必须串联接入。", "把电流表当电压表并联。", { type: "experiment" }),
      physicsPractice("巩固", "并联电流", "并联电路中两支路电流分别为 0.2A 和 0.3A，干路电流是多少？", ["0.5A", "0.1A", "0.6A"], "0.5A", "并联干路电流等于各支路电流之和。", "把并联电流误认为处处相等。", { type: "calculation" }),
      physicsPractice("提升", "电表量程", "使用电流表前不能确定电流大小时，通常应先选哪个量程？", ["大量程", "小量程", "不用量程"], "大量程", "先用大量程试触，避免电流过大损坏电流表。", "直接用小量程导致指针打满。", { type: "experiment" }),
    ],
    "phy-13-4": [
      physicsPractice("基础", "电压表接法", "测量小灯泡两端电压，电压表应怎样接入？", ["与小灯泡并联", "与小灯泡串联", "直接替代小灯泡"], "与小灯泡并联", "电压表测两点间电压，应并联在被测元件两端。", "把电压表和电流表接法混淆。", { type: "experiment" }),
      physicsPractice("巩固", "串联电压", "串联电路中两个电阻两端电压分别为 2V 和 4V，电源电压是多少？", ["6V", "2V", "4V"], "6V", "串联电路总电压等于各部分电压之和。", "把串联电压误认为处处相等。", { type: "calculation" }),
      physicsPractice("提升", "并联电压", "并联电路中电源电压为 6V，各支路两端电压通常是多少？", ["6V", "3V", "12V"], "6V", "并联支路两端直接接在电源两端，电压相等。", "把并联电压平均分。", { type: "comprehensive" }),
    ],
  };

  const lessonTitle = stripLessonNumber(lessonItem.title);
  const firstFormula = lessonItem.formulas?.[0] ?? lessonItem.keyPoints?.[0] ?? lessonTitle;
  const questions = bank[lessonItem.id] ?? fallbackByLesson[lessonItem.id] ?? [
    physicsPractice("基础", lessonTitle, `下列说法中与“${lessonTitle}”相符的是哪一项？`, [lessonItem.keyPoints?.[0] ?? firstFormula, "只看题目关键词，不看物理条件", "公式中的单位可以随意省略"], lessonItem.keyPoints?.[0] ?? firstFormula, `本课核心是把现象、物理量和条件对应起来：${lessonItem.keyPoints?.[0] ?? firstFormula}。`, "只背结论，不判断条件。", { type: "choice" }),
    physicsPractice("巩固", lessonTitle, `围绕“${lessonTitle}”，遇到含数据题时最容易漏掉哪一项？`, ["统一单位并写出物理量关系", "只写最终数字", "把题目所有数字都相加"], "统一单位并写出物理量关系", `含数据物理题要先标出已知量，再选用 ${firstFormula} 等关系。`, "不写单位，导致结果没有物理意义。", { type: "calculation" }),
    physicsPractice("提升", lessonTitle, `与“${lessonTitle}”有关的实验或现象分析，答案必须包含什么？`, ["现象、条件和对应规律", "只写“因为如此”", "只抄题目中的名词"], "现象、条件和对应规律", "物理解释题要说清现象是什么、条件是否满足、用了哪条规律。", "用一句结论代替分析过程。", { type: "comprehensive" }),
  ];
...
function defaultPracticeSteps(subject, type, concept) {
  const shared = {
    math: ["先把题干条件转化成式子、图形或数量关系。", "再用对应公式、定理或判别条件求解，并检查范围。"],
    physics: ["先画出情境图或电路图，标明已知物理量。", "再选择对应规律列式，计算后检查单位和物理意义。"],
    chemistry: ["先判断涉及的物质、现象和反应条件。", "再用性质、实验操作或符号表达解释结论。"],
  };
  const extra = {
    blank: `把“${concept}”对应的关键词或数据补完整。`,
    calculation: `写出“${concept}”对应的公式或数量关系。`,
    experiment: `把“${concept}”放回实验步骤、现象和安全要求中判断。`,
    comprehensive: `把“${concept}”和题目中的多个条件连起来。`,
    choice: `逐项排除和“${concept}”不符合的选项。`,
  };
  return [extra[type] ?? extra.choice, ...(shared[subject] ?? shared.math)];
}

function mathPractice(difficulty, concept, question, choices, answer, explanation, trap, options = {}) {
  const type = options.type ?? inferPracticeType("math", question, concept);
  return {
    type,
    difficulty,
    concept,
    ...
    explanation,
    trap,
    steps: options.steps ?? defaultPracticeSteps("math", type, concept),
    sourceType: options.sourceType ?? "original-variant",
    sourceNote: options.sourceNote ?? "原创变式 · 真题考法参考",
  };
}

function chemistryPractice(difficulty, concept, question, choices, answer, explanation, trap, options = {}) {
  const type = options.type ?? inferPracticeType("chemistry", question, concept);
  return {
    type,
    difficulty,
    concept,
    ...
    explanation,
    trap,
    steps: options.steps ?? defaultPracticeSteps("chemistry", type, concept),
    sourceType: options.sourceType ?? "original-variant",
    sourceNote: options.sourceNote ?? "原创变式 · 真题考法参考",
  };
}

function physicsPractice(difficulty, concept, question, choices, answer, explanation, trap, options = {}) {
  const type = options.type ?? inferPracticeType("physics", question, concept);
  return {
    type,
    difficulty,
    concept,
    ...
    explanation,
    trap,
    steps: options.steps ?? defaultPracticeSteps("physics", type, concept),
    sourceType: options.sourceType ?? "original-variant",
    sourceNote: options.sourceNote ?? "原创变式 · 真题考法参考",
  };
}
